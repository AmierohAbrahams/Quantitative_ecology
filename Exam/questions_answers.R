...
# a NMDS...
# Chosen because it is the most suitable method for ordination as this rank-based approach is more 'flexible' regarding how the distances in the observed multivariate space are mapped to the ordination distance. The relationship is non-linear, as can be seen in the Shepard diagram. NMDS more faithfully retains the pairwise dissimilarity between objects in a low-dimensional space.
