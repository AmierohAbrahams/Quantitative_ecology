...
```{r}
OMG THEM BOX PLOTS JUST DEFEATED ME...........
```
...
line2 <- ggplot(data = DoubsEnv, aes(x = dfs, y = flo)) +
  geom_line() +
    labs(x = "Distance from the source (km)", y = "Discharge (m3/s)", title = "Altitude") +
    theme_bw() +
    theme(panel.border = element_rect(fill = NA, colour = "black", size = 1),
          axis.text = element_text(colour ="black"),
          axis.ticks = element_line(colour ="black"))
...
line3 <- ggplot(data = DoubsEnv, aes(x = dfs, y = oxy)) +
  geom_line() +
    labs(x = "Distance from the source (km)", y = "Oxygen (mg/L)", title = "Altitude") +
    theme_bw() +
    theme(panel.border = element_rect(fill = NA, colour = "black", size = 1),
          axis.text = element_text(colour ="black"),
          axis.ticks = element_line(colour ="black"))
...
line4 <- ggplot(data = DoubsEnv, aes(x = dfs, y = nit)) +
  geom_line() +
    labs(x = "Distance from the source (km)", y = "Nitrate (mg/L)", title = "Altitude") +
    theme_bw() +
    theme(panel.border = element_rect(fill = NA, colour = "black", size = 1),
          axis.text = element_text(colour ="black"),
          axis.ticks = element_line(colour ="black"))
